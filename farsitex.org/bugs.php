...
<link rel="stylesheet" href="https://a.fsdn.com/con/css/sf-psp.css?1513198786" type="text/css">
    ...
    <style type="text/css" >.sfdl { width:250px;height:48px;padding:0;position:relative;font:bold 12px/1.17 sans-serif !important; border:1px solid #aaa;display:inline;float:left;text-decoration:none;box-shadow:rgba(255, 255, 255, 0.6) 0 1px 0 0;border-radius:4px;background:no-repeat #e5e5e5 8px center url(data:image/png;base64,);background-image:url(data:image/png;base64,), linear-gradient(to bottom, #fff 0%, #ccc 100%);background-position:8px center, 0 0;margin:0 10px 0px 0;overflow:hidden;color:#555 !important;}.sfdl:hover { cursor:pointer;text-decoration:none;background:8px center no-repeat #eee url(data:image/png;base64,);}.sfdl-lite { background:0 center no-repeat #337733 none;color:white !important;height:auto;padding:0.5em 1em;text-align:center;border-radius:4px;background-image:linear-gradient(to bottom, #339933 0%, #337733 100%);}.sfdl-lite:hover { background:0 center no-repeat #339933;}.sfdl span { border-radius:3px;display:block;margin:3px;margin-left:35px;padding:4px;text-align:left;color:#FFF;background:#363;background-image:linear-gradient(to bottom, #393 0%, #373 100%);overflow:hidden;height:34px;}.sfdl b { display:block;line-height:17.0px;}.sfdl small { display:block;line-height:17.0px;color:#ADC2AD; font-weight:normal;white-space:nowrap;overflow:hidden;font-size:77%;}.info-circle{ right:10px;bottom:16px;}.direct-dl{ font-size:10px;text-align:right;display:inline-block;width:100%;}</style>
        ...
        <style type="text/css">.b98bd1098bdcf702b720ecfdf40df18e30e27c0d6 { display: none !important; }</style>
...
<form action="https://sourceforge.net/user/newsletters/subscribe?source=PSP" method="post" class="newsletter-subscribe-form compliance-form optin-wide kmunl-subscribe-form" data-shortname="farsitex" data-handler="KMUNSWidget">
    <input type="hidden" name="XHw59mHOH30vJa2WU1943d3djy9E" value="user">
    <input type="hidden" name="XCh59mG:QyDH9DYfjZrIAnskocJ4" value="PSP">
    <div class="clearfix input-group-main">
        <div class="nsw-error-container input-set stacked">
            ...
            <input type="email" class="subscriber-email" name="XCQh_jHSfrlmThRkkgcXC0zvJgkg" placeholder="Enter your email address" value="" required>
        </div>
        ...
        <label class="input-set stacked">
            ...
            <span class="input">
<select id="country" name="XCw59mHOH30uVYw99oVV3XITakWw" required class="use-placeholder-color">
    <option value=""></option>
    ...
    <option value="ZW">Zimbabwe</option>
        ...
        <label class="input-set stacked input-set-state">
            ...
            <span class="input">
<select id="state" name="XCR5mjGmWrlmThRkkgcXC0zvJgkg"  class="use-placeholder-color">
    <option value=""></option>
...
<label class="input-set input-set input-set-kmu kmunl_consent">
    <span class="checkbox"> <input type="checkbox" name="XDwZ_mB6YqL:F3Dm0NEp9wCjtkI0" value="farsitex"  data-consent-action data-consent-id=59aed8e456585fa9603b60e8 ></span>
...
<label class="input-set input-set input-set-newsletters-optin-sitewide allow-precheck loose-consent-requirement kmunl_consent">
    <span class="checkbox"> <input type="checkbox" name="XBwN3mm6fyEbibXiDsepBlRHFm_A" value="sitewide"  data-consent-action data-consent-id=59aed8e456585fa9603b60e9 ></span>
...
<label class="input-set input-set input-set-newsletters-optin-all kmunl_consent">
    <span class="checkbox"> <input type="checkbox" name="XBwN3mm6fyEbibXiDsepBlRHFm_A" value="sitewide research"  data-consent-action data-consent-id=59aed8e456585fa9603b60ea ></span>
...
<label class="input-set stacked inset">
    <span class="checkbox"> <input type="checkbox" name="XAQJ0i3iB3m3iZ3qZ0fJHcwecu2A" value="artificial-intelligence"  data-consent-action data-consent-id=596517bdc14bed0737e41a50 ></span>
...
<label class="input-set stacked inset">
    <span class="checkbox"> <input type="checkbox" name="XAQJ0i3iB3m3iZ3qZ0fJHcwecu2A" value="cloud"  data-consent-action data-consent-id=596517bdc14bed0737e41a4f ></span>
...
<label class="input-set stacked inset">
    <span class="checkbox"> <input type="checkbox" name="XAQJ0i3iB3m3iZ3qZ0fJHcwecu2A" value="network-security"  data-consent-action data-consent-id=596517bdc14bed0737e41a4e ></span>
...
<label class="input-set stacked inset">
    <span class="checkbox"> <input type="checkbox" name="XAQJ0i3iB3m3iZ3qZ0fJHcwecu2A" value="hardware"  data-consent-action data-consent-id=596517bdc14bed0737e41a4d ></span>
...
<label class="input-set stacked inset">
    <span class="checkbox"> <input type="checkbox" name="XAQJ0i3iB3m3iZ3qZ0fJHcwecu2A" value="software-development"  data-consent-action data-consent-id=596517bdc14bed0737e41a4c ></span>
...
<label class="input-set stacked inset input-set-consent-email minimum-explicit-required">
    <span class="checkbox"> <input type="checkbox" name="XAw59g2mSzkbJZW:E2u4gawF6rTk" value="email"  data-consent-action data-consent-id=59aed8e456585fa9603b60ec ></span>
...
<label class="input-set stacked inset prompt-phone">
    <span class="checkbox"> <input type="checkbox" name="XAw59g2mSzkbJZW:E2u4gawF6rTk" value="phone"  data-consent-action data-consent-id=596517bdc14bed0737e41a51 ></span>
...
<label class="input-set stacked inset prompt-phone">
    <span class="checkbox"> <input type="checkbox" name="XAw59g2mSzkbJZW:E2u4gawF6rTk" value="sms"  data-consent-action data-consent-id=596517bdc14bed0737e41a53 ></span>
    ...
    <label class="input-set inset input-phone hide ">
        ...
        <span class="input">
            <input type="tel" name="XCR16gnOWrlmThRkkgcXC0zvJgkg" value="">
        </span>
        ...
        <input type="hidden" name="XBwN3mm6fyEbibXiDsepBlRHFm_A" class="input-assumed-newsletters" value="">
        <input type="hidden" name="XDwZ_mB6YqL:F3Dm0NEp9wCjtkI0" class="input-assumed-kmu" value="">
    </div>
...
<label class="input-set stacked input-set-agree-general allow-precheck">
    <span class="checkbox"> <input type="checkbox" name="XCw59g26Ww0aVYw99oVV3XITakWw" value="consent"  data-consent-action data-consent-id=5a26cb73ecf83256408fd377 ></span>
...
<label class="input-set stacked input-set-agree-general-gdpr minimum-explicit-required">
    <span class="checkbox"> <input type="checkbox" name="XCw59g26Ww0aVYw99oVV3XITakWw" value="consent"  data-consent-action data-consent-id=5a26cb73ecf83256408fd378 ></span>
  ...
  <input type="hidden" name="_visit_cookie" value="753a9834-4d97-47c0-b3be-f81587655e34"/>
    <input type='hidden' name='timestamp' value='1513322903'/>
    <input type='hidden' name='spinner' value='XDG0S7R3zrTKWCArwsoFEGAIRqLQ'/>
    <p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnQKVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnQKVYw99oVV3XITakWw' name='XCgV9g3iKnTH9DYfjZrIAnskocJ4' type=
             'text'/></p>
    <p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnQOVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnQOVYw99oVV3XITakWw' name='XCgV9g3iKnDH9DYfjZrIAnskocJ4' type=
             'text'/></p>
</form>
<script>
    ...
    <div class="listing-body clearfix standard">
        ...
        <div class="tile clearfix">
            ...
            <div class="download standard">
                ...
                <img src="https://a.slashdotmedia.com/www/delivery/lg.php?bannerid=22098&amp;campaignid=3347&amp;zoneid=18566&amp;cb=1bc30bbcaf" alt="WhatsUp&reg; Gold - Start A Free 30-Day Trial" width="1" height="1" style="display: none;"/>

                

                
                <a class="sfdl sfdl-lite" target="_blank" rel="nofollow" href="https://a.slashdotmedia.com/www/delivery/ck.php?oaparams=2__bannerid=22098__zoneid=18566__cb=1bc30bbcaf__oadest=https%3A%2F%2Fwww.ipswitch.com%2Fforms%2Ffree-trials%2Fwhatsup-gold%3Futm_campaign%3Dq417_sourceforge%26utm_source%3Dsourceforge%26utm_medium%3Ddisplay%26utm_content%3Dwug_eval">Start A Free Trial</a>
...
gptadRenderers['SF_ProjectSum_728x90_B']();  // jshint ignore:line
  ...
  <input type="hidden" name="_visit_cookie" value="753a9834-4d97-47c0-b3be-f81587655e34"/>
                <input type='hidden' name='timestamp' value='1513322903'/>
                <input type='hidden' name='spinner' value='XDG0S7R3zrTKWCArwsoFEGAIRqLQ'/>
                <p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnAKVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnAKVYw99oVV3XITakWw' name='XCgV9g3iKnTH9DYfjZrIAnskocJ4' type=
             'text'/></p>
                <p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnAOVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnAOVYw99oVV3XITakWw' name='XCgV9g3iKnDH9DYfjZrIAnskocJ4' type=
             'text'/></p>
            <p>Briefly describe the problem (required):
            <input name="XBwl3nn6BxELiYWWesepBlRHFm_A" type="text" required>
            </p>
            ...
            <input name="XBQ5:hH6Y8kfkZAmbtwxXzDFVLn8" type="url">
            </p>
            <textarea id="gpt-info" name="XCAlzmXzwxjcbG97D9gePIdo7VIw"></textarea>
...
<form action="https://sourceforge.net/user/newsletters/subscribe" method="post" class="newsletter-subscribe-form compliance-form "  >
    ...
    <div class="form">
        ...
        <input type="email" name="XCQh_jHSfrlmThRkkgcXC0zvJgkg"  placeholder="email@address.com" value="" required>
        ...
        <label class="input-set stacked input-set-country">
            ...
            <span class="input">
<select id="country-floating" name="XCw59mHOH30uVYw99oVV3XITakWw" required class="use-placeholder-color">
    <option value=""></option>
    <option value="AF">Afghanistan</option>
    <option value="AX">Aland Islands</option>
    <option value="AL">Albania</option>
    ...
    <option value="ZW">Zimbabwe</option>
        ...
        <label class="input-set stacked input-set-state">
            ...
            <span class="input">
<select id="state-floating" name="XCR5mjGmWrlmThRkkgcXC0zvJgkg"  class="use-placeholder-color">
    <option value=""></option>
    <option value="AL">Alabama</option>
    <option value="AK">Alaska</option>
    <option value="AZ">Arizona</option>
...
<label class="input-set stacked inset prompt-phone">
    ...
    <input type="hidden" name="XBwN3mm6fyEbibXiDsepBlRHFm_A" value="sitewide" class="newsletter-optin-assume">
    
 

<label class="input-set input-set-agree-general allow-precheck">
    <span class="checkbox"> <input type="checkbox" name="XCw59g26Ww0aVYw99oVV3XITakWw" value="consent"  data-consent-action data-consent-id=5a26cb73ecf83256408fd377 required></span>
    <span class="checkbox-label">I agree to receive these communications from SourceForge.net.  I understand that I can withdraw my consent at anytime. Please refer to our <a href="http://slashdotmedia.com/terms-of-use">Terms of Use</a> and <a href="https://slashdotmedia.com/privacy-statement/">Privacy Policy</a> or <a href="https://sourceforge.net/support">Contact Us</a> for more details.</span>
...
<label class="input-set input-set-agree-general-gdpr allow-precheck hide-initially">
    <span class="checkbox"> <input type="checkbox" name="XCw59g26Ww0aVYw99oVV3XITakWw" value="consent"  data-consent-action data-consent-id=5a26cb73ecf83256408fd378 required></span>
    <span class="checkbox-label">I agree to receive these communications from SourceForge.net via the means indicated above.  I understand that I can withdraw my consent at anytime. Please refer to our <a href="http://slashdotmedia.com/terms-of-use">Terms of Use</a> and <a href="https://slashdotmedia.com/privacy-statement/">Privacy Policy</a> or <a href="https://sourceforge.net/support">Contact Us</a> for more details.</span>
    ...
    <input type="hidden" name="XHw59mHOH30vJa2WU1943d3djy9E" value="user">
    <input type="hidden" name="XDwZ_mB6YqL:F3Dm0NEp9wCjtkI0" value="">


  <input type="hidden" name="_visit_cookie" value="753a9834-4d97-47c0-b3be-f81587655e34"/>
<input type='hidden' name='timestamp' value='1513322903'/>
<input type='hidden' name='spinner' value='XDG0S7R3zrTKWCArwsoFEGAIRqLQ'/>
<p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnwKVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnwKVYw99oVV3XITakWw' name='XCgV9g3iKnTH9DYfjZrIAnskocJ4' type=
             'text'/></p>
<p class='b98bd1098bdcf702b720ecfdf40df18e30e27c0d6'><label for='XCwV9g3iKnwOVYw99oVV3XITakWw'>You seem to have CSS turned off.
             Please don't fill out this field.</label><input id='XCwV9g3iKnwOVYw99oVV3XITakWw' name='XCgV9g3iKnDH9DYfjZrIAnskocJ4' type=
             'text'/></p>
</form>
