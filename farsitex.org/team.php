...
<li class="listitem"><span class="selecteditem">Project Team</span>
</li>
...
<p>
  The FarsiTeX Project, started in 1992, is maintained by <strong>the FarsiTeX
  Project Team</strong>, which currently consists of the following persons:
</p>
  <ul class="members">
    <li><a href="http://sina.sharif.ac.ir/~ghodsi/">Dr. Mohammad Ghodsi</a>   (project director)</li>
    <li><a href="http://behdad.org/">Behdad Esfahbod</a>        (technical manager, <em>Parsi</em> fonts, 1.0pre1 engine, Linux port)</li>
 </ul>
</p>
<p>
...
<p>
  <ul>
    <li><a href="http://www.cit.ics.saitama-u.ac.jp/~ahassan">Hassan Abolhasani</a>     (original engine)</li>
    <li><a href="mailto:m_babaie@users.sourceforge.net">Dr. Massoud Babaie-Zadeh</a></li>
    <li><a href="http://www.ece.nwu.edu/~kiarash">Kiarash Bazargan</a>      (original Dos editor)</li>
    <li><a href="http://ce.sharif.edu/~dashti/">Sasan Dashtinezhad</a>    (old home page web administrator)</li>
    <li><a href="mailto:bakuii@users.sourceforge.net">Mohammad Bakuii</a>         (FTeX2HTML)</li>
    <li>Bardia Hesam</li>
    <li><a href="http://www.cs.umd.edu/~okhtay/">Okhtay Ilghami</a>            (helped with the Windows editor)</li>
    <li><a href="mailto:hadi@users.sourceforge.net">Hadi Karimi</a>            (Azin and Titr fonts)</li>
    <li><a href="http://www.mit.edu/~mahdian/">Mohammad Mahdian</a></li>
    <li><a href="mailto:mehran@users.sourceforge.net">Mehran Mehr</a>             (DOS editor)</li>
    <li>Shiva Nejati               (Windows editor, Persian MakeIndex)</li>
    <li><a href="http://sina.sharif.ac.ir/~roozbeh/">Roozbeh Pournader</a>     (technical manager, all-hands person)</li>
    <li><a href="http://www.cs.toronto.edu/~mehrdad/">Mehrdad Sabetzadeh</a>     (Windows editor)</li>
    <li>Mehran Sharghi            (<em>Scientific Farsi</em> fonts)</li>
    <li><a href="mailto:bigbug@users.sourceforge.net">Mohammad Toossi</a></li>
  </ul>
</p>
<p>
  And special thanks should be given to all people who have contributed to the
  project, including:
  <ul>
    <li>Parvaneh Asghari          (early designer of Traffic fonts)</li>
    <li>Jafar Haghollahi          (first work to design Persian fonts)</li>
    <li>Jamshid Yousefi           (early designer of Titr fonts)</li>
  </ul>
</p>
<center>
  <img src="image/team.jpeg" alt="A picture of FarsiTeX Project Team members, taken 1998"width="472" height="348" /></center>
<hr /></td>
</tr>
</tbody>
</table>
